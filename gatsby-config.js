...
module.exports = {
    ...
    plugins: [
        ...
        /* Syntax highlighting plugin (Prism) */
        {
                ...
                plugins: [
                    {
                        ...
                        options: {
                            ...
                            // Customize the prompt used in shell output Values below are default
                            prompt: {
                                user: "root",
                                host: "localhost",
                                global: false
                            },
                            // By default the HTML entities <>&'" are escaped. Add additional HTML escapes by providing a mapping of HTML entities and their escape value IE: { '}': '&#123;' }
                            escapeEntities: {}
                        }
                    }
                ]
